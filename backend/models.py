...
class Movie(db.Model):
    ...
    def __init__(self, imdb_id, tmdb_id, title, poster, overview, rating):
    ...
    def __str__(self):
        return f'{{ "id": "{self.id}", "imdb_id": "{self.imdb_id}", "tmdb_id": "{self.tmdb_id}", "title": "{self.title}", "poster": "{self.poster}", "overview": "{self.overview}", "rating": "{self.rating}" }}'